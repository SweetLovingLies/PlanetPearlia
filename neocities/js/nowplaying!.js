window.onload = function () {
        ...
        <div id="cloudPlayer" class="hidden">
            <svg id="graphicParent" width="350" height="600" viewBox="0 0 1300 2200">
                <g id="swingGroup">
                    ...
                    <path id="string2" d="M600, 1160 Q600,1000 600, 1600" stroke="black" fill="none" stroke-width="15" /> 
    ...
    const smoothStop = () => {
        ...
        gsap.to("#swingGroup", {
            rotate: 0, // Stop the rotation
            duration: 1, // Duration for the smooth stop
            ease: "power4.out", // Ease out for smooth deceleration
        });

        gsap.to("#string", {
            attr: { d: "M600,0 Q600,300 600,600" }, // Reset string position
            duration: 1,
            ease: "power4.out",
        });

        gsap.to("#details", {
            x: 20, // Stop the details swing
            rotate: 0,
            duration: 1,
            ease: "power4.out",
        });
